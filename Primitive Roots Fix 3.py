...
# Printing the sum board.
print()
print('Displaying the board of sums')
for col_label in range(1, phinumber + 1):
    print('\ta^{}'.format(col_label), end='')
print()
